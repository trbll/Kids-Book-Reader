...
from settings import TARGET_LANGUAGE, ELEVENLABS_VOICE_ID
    ...
    READER_STORY_TEXT_EXTRACTION_MESSAGES.append(
        {
            ...
            'content': [
                {
                    'type': 'text',
                    'text': f'Here is the next page of the book. Please return ONLY the story text in the image in the target language of: {TARGET_LANGUAGE}. DO NOT CONTINUE OR EXTRAPOLATE FROM THE TEXT YOU FOUND. JUST RETURN THE TEXT IN THE TARGET LANGUAGE! No commentary before or after the text, either.'
                },
                {
                    'type': 'image_url',
                    'image_url': {
